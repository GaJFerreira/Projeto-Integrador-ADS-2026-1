  ...
  return (
    ...
    >
      <CardContent sx={{ p: 3, '&:last-child': { pb: 3 } }}>
        ...
        >
          <Box>
            <Typography variant="caption" color="text.secondary" display="block" fontWeight="700" sx={{ letterSpacing: '0.05em', textTransform: 'uppercase', mb: 0.5, fontSize: '0.65rem' }}>
              ID do Dispositivo
            </Typography>
        ...
        <Box display="flex" flexDirection="column" gap={2} sx={{ borderTop: '1px solid rgba(0,0,0,0.05)', pt: 2.5 }}>
          {/* Último Batimento Block */}
          <Box display="flex" alignItems="flex-start" gap={1.5}>
            <AccessTime sx={{ fontSize: 18, color: 'text.secondary', mt: 0.25 }} />
            <Box>
              <Typography variant="caption" color="text.secondary" fontWeight="700" sx={{ letterSpacing: '0.03em', display: 'block', textTransform: 'uppercase', fontSize: '0.625rem', mb: 0.25 }}>
                Último Batimento
              </Typography>
          ...
          <Box display="flex" alignItems="flex-start" gap={1.5}>
            {device.ativo ? (
              ...
              <ToggleOff sx={{ fontSize: 20, color: 'text.secondary', mt: 0.25 }} />
            )}
            <Box>
              <Typography variant="caption" color="text.secondary" fontWeight="700" sx={{ letterSpacing: '0.03em', display: 'block', textTransform: 'uppercase', fontSize: '0.625rem', mb: 0.25 }}>
                Status do Sistema
              ...
              <Typography 
                variant="body2" 
                color={device.ativo ? '#2e7d32' : 'text.secondary'} 
                fontWeight={device.ativo ? '700' : '500'}
                sx={{ lineHeight: 1.3 }}
              >
                {device.ativo ? 'Ativo e Operacional' : 'Inativo'}
              </Typography>
            </Box>
          </Box>
        </Box>
