 ...
 * Mudança de arquitetura: as queries nativas foram atualizadas
 * para referenciar o schema {@code care_hub} explicitamente (ex:
 * {@code care_hub.usuario} em vez de {@code users}), pois a entidade
 * {@link Cuidador}
 * agora persiste em {@code care_hub.ch_cuidador} com FK para
 * {@code care_hub.usuario}.
 */
@Repository
