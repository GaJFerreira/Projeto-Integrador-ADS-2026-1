...
import br.pucgo.ads.projetointegrador.dosecerta.database.entity.*;
import br.pucgo.ads.projetointegrador.dosecerta.dto.*;
import br.pucgo.ads.projetointegrador.dosecerta.database.repository.*;
...
@Service("doseCertaMedicamentoService")
public class MedicamentoService {
    ...
    public List<Medicamento> listarPorUsuario(Long platformUserId) {
        return medicamentoRepository.findByPlatformUserId(platformUserId);
    }
    ...
    // ===========================================================
    @Transactional
    public Medicamento salvarFromDTO(MedicamentoCreateDTO dto, Long anvisaId, Long platformUserId) {

        Medicamento medicamento = new Medicamento();
        medicamento.setPlatformUserId(platformUserId);
    ...
    public List<MedicamentoResponseDTO> listarPorUsuarioComDetalhes(Long platformUserId) {
        return medicamentoRepository.findByPlatformUserId(platformUserId).stream()
