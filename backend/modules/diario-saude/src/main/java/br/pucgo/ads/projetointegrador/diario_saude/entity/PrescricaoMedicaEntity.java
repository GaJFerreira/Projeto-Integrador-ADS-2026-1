...
@Entity
@Table(name = "ds_prescricao_medica", schema = "diario_saude")
public class PrescricaoMedicaEntity {
    ...
    // ID do médico na plataforma (sem importar User)
    @Column(name = "id_medico", nullable = false)
    private Long medicoId;

    // Relação (M:1) Usuário — entidade própria do módulo
    ...
    @OneToMany(mappedBy = "prescricaoMedica", fetch = FetchType.EAGER)
    ...
    public Set<ExercicioRecomendadoEntity> getExerciciosRecomendados() { return exerciciosRecomendados; }
    public void setExerciciosRecomendados(Set<ExercicioRecomendadoEntity> exerciciosRecomendados) { this.exerciciosRecomendados = exerciciosRecomendados; }
}
