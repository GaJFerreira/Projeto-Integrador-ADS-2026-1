package br.pucgo.ads.projetointegrador.eldencare.mapper;
...
import br.pucgo.ads.projetointegrador.eldencare.dto.ItemPlanoDTO;
import br.pucgo.ads.projetointegrador.eldencare.dto.PlanoDTO;

import java.util.ArrayList;
import java.util.List;
import java.util.UUID;

public final class EldencareMapper {
    private EldencareMapper() {}

    public static PlanoDTO toDTO(ex_plano plano) {
        if (plano == null) return null;

        // resolve o participanteId a partir do plano ou da resposta do questionário
        ...
        if (plano.getDias() != null) {
            for (ex_dia_plano dia : plano.getDias()) {
                String dataOuOrdem = dia.getDataOuOrdem();
